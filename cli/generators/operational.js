...
var $author$project$Operations$InputError = {$: 'InputError'};
var $elm$core$Basics$identity = function (x) {
	return x;
};
var $author$project$Operations$SchemaReceived = function (a) {
...
var $author$project$Operations$SchemaGet = function (a) {
	return {$: 'SchemaGet', a: a};
};
var $author$project$Operations$SchemaInline = function (a) {
...
var $author$project$Operations$flagsDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A3(
			$elm$json$Json$Decode$map2,
			F2(
				function (namespace, schemaUrl) {
					return $author$project$Operations$SchemaGet(
			...
			A2($elm$json$Json$Decode$map, $author$project$Operations$SchemaInline, $author$project$GraphQL$Schema$decoder)
		]));
...
var $author$project$Operations$httpErrorToString = function (err) {
	switch (err.$) {
		case 'BadUrl':
			var msg = err.a;
			return 'Bad Url: ' + msg;
...
var $author$project$GraphQL$Operations$CanonicalAST$Operation = function (a) {
	return {$: 'Operation', a: a};
};
var $author$project$GraphQL$Operations$CanonicalAST$Query = {$: 'Query'};
var $author$project$GraphQL$Operations$CanonicalAST$FieldObject = function (a) {
	return {$: 'FieldObject', a: a};
};
var $author$project$GraphQL$Operations$CanonicalAST$FieldScalar = function (a) {
	return {$: 'FieldScalar', a: a};
};
var $author$project$GraphQL$Operations$CanonicalAST$FieldUnion = function (a) {
	return {$: 'FieldUnion', a: a};
};
var $author$project$GraphQL$Operations$Canonicalize$ObjectUnknown = function (a) {
	return {$: 'ObjectUnknown', a: a};
};
var $author$project$GraphQL$Operations$Canonicalize$QueryUnknown = function (a) {
	return {$: 'QueryUnknown', a: a};
};
var $author$project$GraphQL$Operations$Canonicalize$UnionUnknown = function (a) {
	return {$: 'UnionUnknown', a: a};
};
var $author$project$GraphQL$Operations$Canonicalize$EnumUnknown = function (a) {
	return {$: 'EnumUnknown', a: a};
};
var $author$project$GraphQL$Operations$CanonicalAST$FieldEnum = function (a) {
	return {$: 'FieldEnum', a: a};
};
var $author$project$GraphQL$Operations$Canonicalize$FieldUnknown = function (a) {
	return {$: 'FieldUnknown', a: a};
};
var $author$project$GraphQL$Operations$CanonicalAST$Name = function (a) {
	return {$: 'Name', a: a};
};
var $author$project$GraphQL$Operations$CanonicalAST$UnionCase = function (a) {
	return {$: 'UnionCase', a: a};
};
var $author$project$GraphQL$Operations$Canonicalize$convertName = function (_v0) {
	var str = _v0.a;
	return $author$project$GraphQL$Operations$CanonicalAST$Name(str);
};
var $author$project$GraphQL$Operations$Canonicalize$Error = function (a) {
	return {$: 'Error', a: a};
};
var $author$project$GraphQL$Operations$Canonicalize$zeroPosition = {_char: 0, line: 0};
var $author$project$GraphQL$Operations$Canonicalize$error = function (deets) {
	return $author$project$GraphQL$Operations$Canonicalize$Error(
		{
			coords: {end: $author$project$GraphQL$Operations$Canonicalize$zeroPosition, start: $author$project$GraphQL$Operations$Canonicalize$zeroPosition},
			error: deets
		});
};
var $author$project$GraphQL$Operations$Canonicalize$extractUnionTags = F2(
	function (vars, captured) {
		extractUnionTags:
		while (true) {
			if (!vars.b) {
				...
				if (_v1.$ === 'Object') {
					var name = _v1.a;
					var $temp$vars = remain,
						$temp$captured = A2($elm$core$List$cons, name, captured);
					vars = $temp$vars;
...
var $author$project$GraphQL$Operations$Canonicalize$matchTag = F3(
	function (tag, tags, _v0) {
		matchTag:
		while (true) {
			var matched = _v0.a;
			var captured = _v0.b;
			if (!tags.b) {
				...
				if (_Utils_eq(top, tag)) {
					return _Utils_Tuple2(
						true,
						_Utils_ap(remain, captured));
				} else {
					var $temp$tag = tag,
						$temp$tags = remain,
						$temp$_v0 = _Utils_Tuple2(
						matched,
						A2($elm$core$List$cons, top, captured));
					tag = $temp$tag;
					tags = $temp$tags;
					_v0 = $temp$_v0;
					continue matchTag;
...
var $author$project$GraphQL$Operations$Canonicalize$reduce = F3(
	function (isValid, items, res) {
		reduce:
		while (true) {
			if (!items.b) {
				return res;
				...
				if (_v1.$ === 'Ok') {
					...
					if (res.$ === 'Ok') {
						var existing = res.a;
						var $temp$isValid = isValid,
							$temp$items = remain,
							$temp$res = $elm$core$Result$Ok(
							A2($elm$core$List$cons, valid, existing));
...
var $author$project$GraphQL$Operations$Canonicalize$todo = function (msg) {
	return $author$project$GraphQL$Operations$Canonicalize$Error(
		{
			coords: {end: $author$project$GraphQL$Operations$Canonicalize$zeroPosition, start: $author$project$GraphQL$Operations$Canonicalize$zeroPosition},
			error: $author$project$GraphQL$Operations$Canonicalize$Todo(msg)
		});
};
var $author$project$GraphQL$Operations$Canonicalize$canonicalizeField = F3(
	function (schema, object, selection) {
		switch (selection.$) {
			case 'Field':
				var field = selection.a;
				var fieldName = $author$project$GraphQL$Operations$AST$nameToString(field.name);
				if (fieldName === '__typename') {
					return $elm$core$Result$Ok(
						$author$project$GraphQL$Operations$CanonicalAST$FieldScalar(
							{
								alias_: A2($elm$core$Maybe$map, $author$project$GraphQL$Operations$Canonicalize$convertName, field.alias_),
								_arguments: _List_Nil,
								directives: _List_Nil,
								name: $author$project$GraphQL$Operations$Canonicalize$convertName(field.name),
								type_: $author$project$GraphQL$Schema$Type$Scalar('typename')
							}));
				} else {
					var matchedField = $elm$core$List$head(
						A2(
							$elm$core$List$filter,
							function (fld) {
								return _Utils_eq(fld.name, fieldName);
							},
							object.fields));
					if (matchedField.$ === 'Just') {
						var matched = matchedField.a;
						return A6($author$project$GraphQL$Operations$Canonicalize$canonicalizeFieldType, schema, object, field, matched.type_, selection, matched.type_);
					} else {
						return $elm$core$Result$Err(
							_List_fromArray(
								[
									$author$project$GraphQL$Operations$Canonicalize$error(
									$author$project$GraphQL$Operations$Canonicalize$FieldUnknown(
										{field: fieldName, object: object.name}))
								]));
					}
				}
			case 'FragmentSpreadSelection':
				...
				return $elm$core$Result$Err(
					_List_fromArray(
						[
							$author$project$GraphQL$Operations$Canonicalize$todo('Fragments in objects aren\'t suported yet!')
						]));
			default:
				...
				return $elm$core$Result$Err(
					_List_fromArray(
						[
							$author$project$GraphQL$Operations$Canonicalize$todo('Inline fragments are not allowed')
						]));
		}
	});
var $author$project$GraphQL$Operations$Canonicalize$canonicalizeFieldType = F6(
	function (schema, object, field, type_, selection, originalType) {
		...
		while (true) {
			switch (type_.$) {
				...
				case 'Object':
					var name = type_.a;
					var _v5 = A2($elm$core$Dict$get, name, schema.objects);
					if (_v5.$ === 'Nothing') {
						return $elm$core$Result$Err(
							_List_fromArray(
								[
									$author$project$GraphQL$Operations$Canonicalize$error(
									$author$project$GraphQL$Operations$Canonicalize$ObjectUnknown(name))
								]));
					} else {
						var obj = _v5.a;
						var selectionResult = A3(
							$author$project$GraphQL$Operations$Canonicalize$reduce,
							A2($author$project$GraphQL$Operations$Canonicalize$canonicalizeField, schema, obj),
							field.selection,
							$elm$core$Result$Ok(_List_Nil));
						if (selectionResult.$ === 'Ok') {
							var canSelection = selectionResult.a;
							return $elm$core$Result$Ok(
								$author$project$GraphQL$Operations$CanonicalAST$FieldObject(
									{
										alias_: A2($elm$core$Maybe$map, $author$project$GraphQL$Operations$Canonicalize$convertName, field.alias_),
										_arguments: _List_Nil,
										directives: _List_Nil,
										...
										wrapper: $author$project$Generate$Input$getWrap(originalType)
									}));
						} else {
							var err = selectionResult.a;
							return $elm$core$Result$Err(err);
						}
					}
				case 'Enum':
					var name = type_.a;
					var _v7 = A2($elm$core$Dict$get, name, schema.enums);
					if (_v7.$ === 'Nothing') {
						return $elm$core$Result$Err(
							_List_fromArray(
								[
									$author$project$GraphQL$Operations$Canonicalize$error(
									$author$project$GraphQL$Operations$Canonicalize$EnumUnknown(name))
								]));
					} else {
						var _enum = _v7.a;
						return $elm$core$Result$Ok(
							$author$project$GraphQL$Operations$CanonicalAST$FieldEnum(
								{
									alias_: A2($elm$core$Maybe$map, $author$project$GraphQL$Operations$Canonicalize$convertName, field.alias_),
									_arguments: _List_Nil,
									directives: _List_Nil,
				...
				case 'Union':
					var name = type_.a;
					var _v8 = A2($elm$core$Dict$get, name, schema.unions);
					if (_v8.$ === 'Nothing') {
						return $elm$core$Result$Err(
							_List_fromArray(
								[
									$author$project$GraphQL$Operations$Canonicalize$error(
									$author$project$GraphQL$Operations$Canonicalize$UnionUnknown(name))
								]));
					} else {
						var union = _v8.a;
						var _v9 = A2($author$project$GraphQL$Operations$Canonicalize$extractUnionTags, union.variants, _List_Nil);
						if (_v9.$ === 'Nothing') {
							return $elm$core$Result$Err(
								_List_fromArray(
									[
							...
							var selectionResult = A3(
								$author$project$GraphQL$Operations$Canonicalize$reduce,
								A3($author$project$GraphQL$Operations$Canonicalize$canonicalizeUnionField, schema, union, vars),
								field.selection,
								$elm$core$Result$Ok(_List_Nil));
							if (selectionResult.$ === 'Ok') {
								var canSelection = selectionResult.a;
								return $elm$core$Result$Ok(
									$author$project$GraphQL$Operations$CanonicalAST$FieldUnion(
										{
											alias_: A2($elm$core$Maybe$map, $author$project$GraphQL$Operations$Canonicalize$convertName, field.alias_),
											_arguments: _List_Nil,
											directives: _List_Nil,
				...
				case 'Interface':
					...
					return $elm$core$Result$Err(
						_List_fromArray(
							[
								$author$project$GraphQL$Operations$Canonicalize$todo('Field Interfaces!')
							]));
				case 'List_':
					var inner = type_.a;
					var $temp$schema = schema,
						$temp$object = object,
						$temp$field = field,
						$temp$type_ = inner,
						$temp$selection = selection,
						$temp$originalType = originalType;
					schema = $temp$schema;
					object = $temp$object;
					field = $temp$field;
					type_ = $temp$type_;
					...
					continue canonicalizeFieldType;
				default:
					var inner = type_.a;
					var $temp$schema = schema,
						$temp$object = object,
...
var $author$project$GraphQL$Operations$Canonicalize$canonicalizeUnionField = F4(
	function (schema, union, remainingAllowedTags, selection) {
		switch (selection.$) {
			case 'Field':
				var field = selection.a;
				var fieldName = $author$project$GraphQL$Operations$AST$nameToString(field.name);
				return (fieldName === '__typename') ? $elm$core$Result$Ok(
					$author$project$GraphQL$Operations$CanonicalAST$FieldScalar(
						{
							alias_: A2($elm$core$Maybe$map, $author$project$GraphQL$Operations$Canonicalize$convertName, field.alias_),
							_arguments: _List_Nil,
					...
					_List_fromArray(
						[
							$author$project$GraphQL$Operations$Canonicalize$todo('Common selections not allowed for gql unions')
						]));
			case 'FragmentSpreadSelection':
				var frag = selection.a;
				return $elm$core$Result$Err(
			...
			default:
				var inline = selection.a;
				var tag = $author$project$GraphQL$Operations$AST$nameToString(inline.tag);
				var _v1 = A3(
					$author$project$GraphQL$Operations$Canonicalize$matchTag,
					tag,
					remainingAllowedTags,
					_Utils_Tuple2(false, _List_Nil));
				var tagMatches = _v1.a;
				var leftOvertags = _v1.b;
				if (tagMatches) {
					var _v2 = A2($elm$core$Dict$get, tag, schema.objects);
					if (_v2.$ === 'Nothing') {
						return $elm$core$Result$Err(
							_List_fromArray(
								[
									$author$project$GraphQL$Operations$Canonicalize$error(
									$author$project$GraphQL$Operations$Canonicalize$ObjectUnknown(tag))
								]));
					} else {
						var obj = _v2.a;
						var selectionResult = A3(
							$author$project$GraphQL$Operations$Canonicalize$reduce,
							function (sel) {
								return A3($author$project$GraphQL$Operations$Canonicalize$canonicalizeField, schema, obj, sel);
							},
							inline.selection,
							$elm$core$Result$Ok(_List_Nil));
						if (selectionResult.$ === 'Ok') {
							var canSelection = selectionResult.a;
							return $elm$core$Result$Ok(
								$author$project$GraphQL$Operations$CanonicalAST$UnionCase(
									{
										directives: _List_Nil,
										selection: canSelection,
										tag: $author$project$GraphQL$Operations$CanonicalAST$Name(tag)
									}));
						} else {
							var err = selectionResult.a;
							return $elm$core$Result$Err(err);
...
var $author$project$GraphQL$Operations$Canonicalize$canonicalizeQuerySelection = F2(
	function (schema, selection) {
		switch (selection.$) {
			case 'Field':
				var field = selection.a;
				var _v1 = A2(
					$elm$core$Dict$get,
					$author$project$GraphQL$Operations$AST$nameToString(field.name),
					schema.queries);
				if (_v1.$ === 'Nothing') {
					return $elm$core$Result$Err(
						_List_fromArray(
							[
								$author$project$GraphQL$Operations$Canonicalize$error(
								$author$project$GraphQL$Operations$Canonicalize$QueryUnknown(
									$author$project$GraphQL$Operations$AST$nameToString(field.name)))
							]));
				} else {
					var query = _v1.a;
					...
					switch (_v2.$) {
						...
						case 'Object':
							var name = _v2.a;
							var _v3 = A2($elm$core$Dict$get, name, schema.objects);
							if (_v3.$ === 'Nothing') {
								return $elm$core$Result$Err(
									_List_fromArray(
										[
										...
										$author$project$GraphQL$Operations$CanonicalAST$FieldObject(
											{
												...
												object: obj,
												selection: canSelection,
												wrapper: $author$project$Generate$Input$getWrap(query.type_)
											}));
								} else {
									var err = selectionResult.a;
									return $elm$core$Result$Err(err);
						...
						case 'Union':
							var name = _v2.a;
							var _v5 = A2($elm$core$Dict$get, name, schema.unions);
							if (_v5.$ === 'Nothing') {
								return $elm$core$Result$Err(
									_List_fromArray(
										[
								...
								var union = _v5.a;
								var _v6 = A2($author$project$GraphQL$Operations$Canonicalize$extractUnionTags, union.variants, _List_Nil);
								if (_v6.$ === 'Nothing') {
									return $elm$core$Result$Err(
										_List_fromArray(
											[
						...
						case 'Interface':
							...
							return $elm$core$Result$Err(
								_List_fromArray(
									[
										$author$project$GraphQL$Operations$Canonicalize$todo('Handle more object types!')
									]));
						case 'List_':
							var inner = _v2.a;
							return $elm$core$Result$Err(
			...
			case 'FragmentSpreadSelection':
				...
				return $elm$core$Result$Err(
					_List_fromArray(
						[
							$author$project$GraphQL$Operations$Canonicalize$todo('Fragments in unions aren\'t suported yet!')
						]));
			default:
				var inline = selection.a;
				return $elm$core$Result$Err(
					_List_fromArray(
						[
							$author$project$GraphQL$Operations$Canonicalize$todo('Unions not supported yet')
						]));
		}
	});
...
var $author$project$GraphQL$Operations$Canonicalize$toCanonVariable = function (def) {
	return {
		defaultValue: def.defaultValue,
		type_: def.type_,
		variable: {
			name: $author$project$GraphQL$Operations$Canonicalize$convertName(def.variable.name)
		}
	};
};
var $elm$core$Debug$todo = _Debug_todo;
var $author$project$GraphQL$Operations$Canonicalize$canonicalizeDefinition = F2(
	function (schema, def) {
		if (def.$ === 'Fragment') {
			var details = def.a;
			return $elm$core$Result$Err(
				_List_fromArray(
					[
						$author$project$GraphQL$Operations$Canonicalize$todo('Top level fragments are not supported yet!')
					]));
		} else {
			var details = def.a;
			var _v1 = details.operationType;
			if (_v1.$ === 'Query') {
				var fieldResult = A3(
					$author$project$GraphQL$Operations$Canonicalize$reduce,
					$author$project$GraphQL$Operations$Canonicalize$canonicalizeQuerySelection(schema),
					details.fields,
					$elm$core$Result$Ok(_List_Nil));
				if (fieldResult.$ === 'Ok') {
					var fields = fieldResult.a;
					return $elm$core$Result$Ok(
						$author$project$GraphQL$Operations$CanonicalAST$Operation(
							{
								directives: _List_Nil,
								fields: fields,
								name: A2($elm$core$Maybe$map, $author$project$GraphQL$Operations$Canonicalize$convertName, details.name),
								operationType: $author$project$GraphQL$Operations$CanonicalAST$Query,
								variableDefinitions: A2($elm$core$List$map, $author$project$GraphQL$Operations$Canonicalize$toCanonVariable, details.variableDefinitions)
							}));
				} else {
					var err = fieldResult.a;
					return $elm$core$Result$Err(err);
				}
			} else {
				return _Debug_todo(
					...
					{
						start: {line: 183, column: 21},
						end: {line: 183, column: 31}
					})('MUTATSION!');
			}
		}
	});
var $author$project$GraphQL$Operations$Canonicalize$canonicalize = F2(
	function (schema, doc) {
		var _v0 = A3(
			$author$project$GraphQL$Operations$Canonicalize$reduce,
			$author$project$GraphQL$Operations$Canonicalize$canonicalizeDefinition(schema),
			doc.definitions,
			$elm$core$Result$Ok(_List_Nil));
		if (_v0.$ === 'Ok') {
			var result = _v0.a;
...
var $author$project$GraphQL$Operations$Canonicalize$errorToString = function (_v0) {
	...
	switch (_v1.$) {
		...
		case 'UnionUnknown':
			var name = _v1.a;
			return 'Unknown Union: ' + name;
		default:
			var field = _v1.a;
			return 'Unknown Field: ' + (field.object + ('.' + field.field));
	}
};
var $author$project$GraphQL$Operations$Validate$errorToString = function (err) {
	switch (err.$) {
		case 'Invalid':
			return 'Invalid';
		case 'Todo':
		...
		case 'InlineFragmentsAreNotAllowed':
			var msg = err.a;
			return 'Inline fragments are not allowed in ' + msg;
		default:
			var name = err.a;
			return 'Unknown arg name: ' + name;
	}
};
...
var $author$project$Elm$Gen$Json$Decode$field = F2(
	function (arg1, arg2) {
		return A2(
...
var $author$project$Elm$fn3 = F5(
	function (name, _v0, _v1, _v2, toBody) {
		var oneName = _v0.a;
		var oneType = _v0.b;
		var twoName = _v1.a;
		var twoType = _v1.b;
		var threeName = _v2.a;
		var threeType = _v2.b;
		var arg3 = A3($author$project$Elm$valueWith, _List_Nil, threeName, threeType);
		var arg2 = A3($author$project$Elm$valueWith, _List_Nil, twoName, twoType);
		var arg1 = A3($author$project$Elm$valueWith, _List_Nil, oneName, oneType);
		var _v3 = A3(toBody, arg1, arg2, arg3);
		var body = _v3.a;
		return A3(
			...
			_Utils_ap(
				...
				_Utils_ap(
					$author$project$Internal$Compiler$getAnnotationImports(twoType),
					_Utils_ap(
						$author$project$Internal$Compiler$getAnnotationImports(threeType),
						body.imports))),
					...
					declaration: $author$project$Internal$Compiler$nodify(
						{
							_arguments: _List_fromArray(
								[
									...
									$author$project$Internal$Compiler$nodify(
									$stil4m$elm_syntax$Elm$Syntax$Pattern$VarPattern(threeName))
								]),
...
var $author$project$Elm$lambda2 = F4(
	function (argBaseName, oneType, twoType, toExpression) {
		var arg2 = A3($author$project$Elm$valueWith, _List_Nil, argBaseName + '2', twoType);
		var arg1 = A3($author$project$Elm$valueWith, _List_Nil, argBaseName, oneType);
		var _v0 = A2(toExpression, arg1, arg2);
		var expr = _v0.a;
		return $author$project$Internal$Compiler$Expression(
			{
				annotation: function () {
					...
					if (_v1.$ === 'Err') {
						...
						return $elm$core$Result$Ok(
							A3(
								...
								_List_fromArray(
									[
										$author$project$Internal$Compiler$getInnerAnnotation(oneType),
										$author$project$Internal$Compiler$getInnerAnnotation(twoType)
									])));
					}
				}(),
				expression: $stil4m$elm_syntax$Elm$Syntax$Expression$LambdaExpression(
					{
						args: _List_fromArray(
							[
								...
								$author$project$Internal$Compiler$nodify(
								$stil4m$elm_syntax$Elm$Syntax$Pattern$VarPattern(argBaseName + '2'))
							]),
...
var $author$project$Elm$Gen$Json$Decode$map2 = F3(
	function (arg1, arg2, arg3) {
		return A2(
			...
			_List_fromArray(
				[
					A2(arg1, $author$project$Elm$pass, $author$project$Elm$pass),
					arg2,
					arg3
				]));
	});
...
var $author$project$GraphQL$Operations$Generate$decodeHelper = A5(
	...
	_Utils_Tuple2(
		...
		$author$project$Elm$Gen$Json$Decode$types_.decoder(
			A2(
				...
				$author$project$Elm$Annotation$var('b')))),
	F3(
		function (name, _new, build) {
			return A2(
				$author$project$Elm$withType,
				$author$project$Elm$Gen$Json$Decode$types_.decoder(
					$author$project$Elm$Annotation$var('b')),
				A3(
					$author$project$Elm$Gen$Json$Decode$map2,
					F2(
						function (_v0, _v1) {
							return A4(
								$author$project$Elm$lambda2,
								'inner',
					...
					A2($author$project$Elm$Gen$Json$Decode$field, name, _new),
					build));
		}));
...
var $author$project$Generate$Input$getWrapFromAst = function (type_) {
	switch (type_.$) {
		case 'Type_':
			var name = type_.a;
			return $author$project$Generate$Input$UnwrappedValue;
		case 'List_':
			var inner = type_.a;
			return $author$project$Generate$Input$InList(
				$author$project$Generate$Input$getWrapFromAst(inner));
		default:
			var inner = type_.a;
			return $author$project$Generate$Input$InMaybe(
				$author$project$Generate$Input$getWrapFromAst(inner));
...
var $author$project$Generate$Args$encodeWrappedJsonValue = F4(
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							A4(
								$author$project$Generate$Args$encodeWrappedJsonValue,
								valName,
								inner,
								encoder,
				...
				return A2(
					...
					function (v) {
						return A3(
							...
							$author$project$Elm$Annotation$unit,
							function (within) {
								return A4($author$project$Generate$Args$encodeWrappedJsonValue, valName, inner, encoder, within);
							});
					},
					val);
		}
...
var $author$project$Elm$Gen$Json$Encode$object = function (arg1) {
	return A2(
		$author$project$Elm$apply,
		A3(
			$author$project$Elm$valueWith,
...
var $author$project$Generate$Args$toJsonValue = F5(
		...
		while (true) {
			switch (fieldType.$) {
				...
				case 'Scalar':
					...
					return A3($author$project$Generate$Args$encodeScalar, scalarName, wrapped, val);
				case 'Enum':
				...
				case 'InputObject':
					...
					if (_v1.$ === 'Nothing') {
						return A4($author$project$Generate$Args$encodeInputObjectArg, inputName, wrapped, val, 0);
					} else {
						var input = _v1.a;
											...
											A2(
												...
												function (field) {
													return A2(
														...
														A5(
															$author$project$Generate$Args$toJsonValue,
															namespace,
															schema,
															field.type_,
												...
												A2(
													...
													many)));
										return A2($elm$core$List$any, $author$project$Generate$Input$isOptional, input.fields) ? $author$project$Elm$Gen$Json$Encode$object(
											A2(
												$author$project$Elm$Gen$List$append,
												requiredVals,
												$author$project$Elm$Gen$GraphQL$Engine$encodeOptionals(
													A2($author$project$Elm$get, $author$project$Generate$Args$embeddedOptionsFieldName, v)))) : $author$project$Elm$Gen$Json$Encode$object(requiredVals);
									},
									val);
							}
						}
...
var $author$project$GraphQL$Operations$Generate$nameIsScalar = function (name) {
	return A2(
...
var $author$project$GraphQL$Operations$Generate$toVariableSchemaType = F2(
	function (schema, type_) {
		switch (type_.$) {
			case 'Type_':
				var name = type_.a;
				return $author$project$GraphQL$Operations$Generate$nameIsScalar(
					$author$project$GraphQL$Operations$AST$nameToString(name)) ? $author$project$GraphQL$Schema$Type$Scalar(
					$author$project$GraphQL$Operations$AST$nameToString(name)) : $author$project$GraphQL$Schema$Type$InputObject(
					$author$project$GraphQL$Operations$AST$nameToString(name));
			case 'List_':
				var inner = type_.a;
				return $author$project$GraphQL$Schema$Type$List_(
					A2($author$project$GraphQL$Operations$Generate$toVariableSchemaType, schema, inner));
			default:
				var inner = type_.a;
				return $author$project$GraphQL$Schema$Type$Nullable(
					A2($author$project$GraphQL$Operations$Generate$toVariableSchemaType, schema, inner));
		}
	});
var $author$project$GraphQL$Operations$Generate$toVariableEncoder = F3(
	function (namespace, schema, _var) {
		var name = $author$project$GraphQL$Operations$CanonicalAST$nameToString(_var.variable.name);
		return A2(
			$author$project$Elm$tuple,
			...
			A5(
				...
				namespace,
				schema,
				A2($author$project$GraphQL$Operations$Generate$toVariableSchemaType, schema, _var.type_),
				$author$project$Generate$Input$getWrapFromAst(_var.type_),
				A2(
					$author$project$Elm$get,
					name,
					$author$project$Elm$value('input'))));
	});
var $author$project$GraphQL$Operations$Generate$encodeVariable = F3(
	function (namespace, schema, def) {
		if (def.$ === 'Fragment') {
			var frag = def.a;
			return _List_Nil;
		} else {
			...
			return A2(
				$elm$core$List$map,
				A2($author$project$GraphQL$Operations$Generate$toVariableEncoder, namespace, schema),
...
var $author$project$Elm$BinOp = F3(
	function (a, b, c) {
...
var $author$project$Elm$applyBinOp = F3(
	function (_v0, _v1, _v2) {
		...
		return $author$project$Internal$Compiler$Expression(
			{
				annotation: $elm$core$Result$Err(
					_List_fromArray(
						[$author$project$Internal$Compiler$SomeOtherIssue])),
				expression: A4(
					$stil4m$elm_syntax$Elm$Syntax$Expression$OperatorApplication,
					symbol,
					dir,
					$author$project$Internal$Compiler$nodify(exprl.expression),
					$author$project$Internal$Compiler$nodify(exprr.expression)),
				imports: _Utils_ap(exprl.imports, exprr.imports),
				skip: false
			});
	});
var $author$project$Elm$pipe = $author$project$Elm$applyBinOp(
	A3($author$project$Elm$BinOp, '|>', $stil4m$elm_syntax$Elm$Syntax$Infix$Left, 0));
var $author$project$GraphQL$Operations$Generate$andField = F3(
	function (name, decoder, builder) {
		return A2(
			$author$project$Elm$pipe,
			builder,
			A2(
				$author$project$Elm$apply,
				$author$project$Elm$value('field'),
				_List_fromArray(
					[
						$author$project$Elm$string(
						$author$project$GraphQL$Operations$CanonicalAST$nameToString(name)),
						decoder
					])));
	});
...
var $author$project$GraphQL$Operations$CanonicalAST$getAliasedName = function (sel) {
	switch (sel.$) {
		case 'Field':
			var details = sel.a;
			return $author$project$GraphQL$Operations$CanonicalAST$nameToString(
				A2($elm$core$Maybe$withDefault, details.name, details.alias_));
		case 'FieldObject':
			var details = sel.a;
			return $author$project$GraphQL$Operations$CanonicalAST$nameToString(
				A2($elm$core$Maybe$withDefault, details.name, details.alias_));
		...
		case 'FragmentSelection':
			var details = sel.a;
			return $author$project$GraphQL$Operations$CanonicalAST$nameToString(details.name);
		default:
			var details = sel.a;
			return $author$project$GraphQL$Operations$CanonicalAST$nameToString(details.tag);
	}
};
var $author$project$GraphQL$Operations$Generate$buildRecordFromVariantFields = function (field) {
	var name = $author$project$GraphQL$Operations$CanonicalAST$getAliasedName(field);
	return A2(
		$author$project$Elm$field,
		name,
		$author$project$Elm$value(name));
};
...
var $author$project$Elm$Gen$Json$Decode$nullable = function (arg1) {
	return A2(
		$author$project$Elm$apply,
		A3(
			$author$project$Elm$valueWith,
...
var $author$project$GraphQL$Operations$Generate$decodeScalarType = function (type_) {
	switch (type_.$) {
		case 'Scalar':
		...
		case 'Nullable':
			var inner = type_.a;
			return $author$project$Elm$Gen$Json$Decode$nullable(
				$author$project$GraphQL$Operations$Generate$decodeScalarType(inner));
		case 'List_':
			var inner = type_.a;
			return $author$project$Elm$Gen$Json$Decode$list(
				$author$project$GraphQL$Operations$Generate$decodeScalarType(inner));
		default:
			return $author$project$Elm$Gen$Json$Decode$succeed(
				$author$project$Elm$string('DECODE UNKNOWN'));
	}
};
...
var $author$project$Generate$Input$decodeWrapper = F2(
	function (wrap, exp) {
		switch (wrap.$) {
			case 'UnwrappedValue':
				return exp;
			case 'InList':
				var inner = wrap.a;
				return $author$project$Elm$Gen$Json$Decode$list(
					A2($author$project$Generate$Input$decodeWrapper, inner, exp));
			default:
				var inner = wrap.a;
...
var $author$project$GraphQL$Operations$Generate$enumValue = F2(
...
var $author$project$GraphQL$Operations$Generate$fieldParameters = function (field) {
	var name = $author$project$GraphQL$Operations$CanonicalAST$getAliasedName(field);
	return _Utils_Tuple2(
		$author$project$Elm$Pattern$var(name),
		$author$project$Elm$Annotation$unit);
};
...
var $author$project$GraphQL$Operations$Generate$removeTypename = function (field) {
	if (field.$ === 'FieldScalar') {
		var scal = field.a;
		var _v1 = scal.type_;
		if ((_v1.$ === 'Scalar') && (_v1.a === 'typename')) {
			return false;
		} else {
			return true;
		}
...
var $author$project$GraphQL$Operations$Generate$subobjectBuilderArgs = function (sel) {
	return _Utils_Tuple2(
		$author$project$Elm$Pattern$var(
			$author$project$Utils$String$formatValue(
				$author$project$GraphQL$Operations$CanonicalAST$getAliasedName(sel))),
		$author$project$Elm$Annotation$unit);
};
var $author$project$GraphQL$Operations$Generate$subobjectBuilderBody = function (fields) {
	return $author$project$Elm$record(
		A2(
			$elm$core$List$map,
			function (selection) {
				var name = $author$project$GraphQL$Operations$CanonicalAST$getAliasedName(selection);
				return A2(
					$author$project$Elm$field,
					name,
...
var $author$project$Elm$Gen$String$moduleName_ = _List_fromArray(
	['String']);
var $author$project$Elm$Gen$String$toLower = function (arg1) {
	return A2(
		$author$project$Elm$apply,
		A3(
			$author$project$Elm$valueWith,
			$author$project$Elm$Gen$String$moduleName_,
			'toLower',
			A2(
				$author$project$Elm$Annotation$function,
				_List_fromArray(
...
var $author$project$GraphQL$Operations$Generate$decodeFields = F2(
	function (fields, exp) {
		decodeFields:
		while (true) {
			if (!fields.b) {
				...
				switch (fields.a.$) {
					...
					case 'FieldObject':
						...
						var obj = field.a;
						var remain = fields.b;
						var $temp$fields = remain,
							$temp$exp = A3(
							$author$project$GraphQL$Operations$Generate$andField,
							$author$project$GraphQL$Operations$CanonicalAST$Name(
								$author$project$GraphQL$Operations$CanonicalAST$getAliasedName(field)),
							A2(
								$author$project$Generate$Input$decodeWrapper,
								obj.wrapper,
								A2(
									$author$project$GraphQL$Operations$Generate$decodeFields,
									obj.selection,
									$author$project$Elm$Gen$Json$Decode$succeed(
										A2(
											$author$project$Elm$lambdaWith,
											A2($elm$core$List$map, $author$project$GraphQL$Operations$Generate$subobjectBuilderArgs, obj.selection),
											$author$project$GraphQL$Operations$Generate$subobjectBuilderBody(obj.selection))))),
							exp);
						fields = $temp$fields;
						exp = $temp$exp;
					...
					case 'FieldScalar':
						...
						var decoded = A3(
							$author$project$GraphQL$Operations$Generate$andField,
							scal.name,
							$author$project$GraphQL$Operations$Generate$decodeScalarType(scal.type_),
							exp);
						var $temp$fields = remain,
							$temp$exp = decoded;
						fields = $temp$fields;
								...
								function (_v4) {
									return A3(
										...
										function (str) {
											return A2(
												$author$project$Elm$caseOf,
												$author$project$Elm$Gen$String$toLower(str),
												_Utils_ap(
													A2(
														$elm$core$List$map,
														function (value) {
															return _Utils_Tuple2(
																$author$project$Elm$Pattern$string(
																	$elm$core$String$toLower(value.name)),
																$author$project$Elm$Gen$Json$Decode$succeed(
																	A2($author$project$GraphQL$Operations$Generate$enumValue, _enum.enumName, value.name)));
														},
														_enum.values),
													_List_fromArray(
														[
															...
															$author$project$Elm$Gen$Json$Decode$fail(
																$author$project$Elm$string('I don\'t recognize this enum!')))
														])));
										});
								},
					...
					case 'FieldUnion':
						...
						var $temp$fields = remain,
							...
							$author$project$GraphQL$Operations$CanonicalAST$Name(
								$author$project$GraphQL$Operations$CanonicalAST$getAliasedName(field)),
							$author$project$GraphQL$Operations$Generate$decodeUnion(union),
							exp);
						fields = $temp$fields;
						exp = $temp$exp;
						continue decodeFields;
...
var $author$project$GraphQL$Operations$Generate$decodeUnion = function (union) {
	return A2(
		$author$project$Elm$Gen$Json$Decode$andThen,
		function (_v2) {
			return A3(
				...
				function (typename) {
					return A2(
						...
						typename,
						_Utils_ap(
							A2($elm$core$List$filterMap, $author$project$GraphQL$Operations$Generate$toUnionVariantPattern, union.selection),
							_List_fromArray(
								[
									_Utils_Tuple2(
									$author$project$Elm$Pattern$wildcard,
									$author$project$Elm$Gen$Json$Decode$fail(
										$author$project$Elm$string('Unknown union type')))
								])));
				});
		},
		A2(
			$author$project$Elm$Gen$Json$Decode$field,
			$author$project$Elm$string('__typename'),
			$author$project$Elm$Gen$Json$Decode$string));
};
var $author$project$GraphQL$Operations$Generate$toUnionVariantPattern = function (selection) {
	if (selection.$ === 'UnionCase') {
		var _var = selection.a;
		var tag = $author$project$Utils$String$formatTypename(
			$author$project$GraphQL$Operations$CanonicalAST$nameToString(_var.tag));
		return $elm$core$Maybe$Just(
			_Utils_Tuple2(
				$author$project$Elm$Pattern$string(tag),
				function () {
					var _v1 = A2($elm$core$List$filter, $author$project$GraphQL$Operations$Generate$removeTypename, _var.selection);
					if (!_v1.b) {
						return $author$project$Elm$Gen$Json$Decode$succeed(
							$author$project$Elm$value(tag));
					} else {
						var fields = _v1;
						return A2(
							$author$project$GraphQL$Operations$Generate$decodeFields,
							...
							$author$project$Elm$Gen$Json$Decode$succeed(
								A2(
									$author$project$Elm$lambdaWith,
									A2($elm$core$List$map, $author$project$GraphQL$Operations$Generate$fieldParameters, fields),
									A2(
										$author$project$Elm$apply,
										$author$project$Elm$value(tag),
										_List_fromArray(
											[
												...
												A2($elm$core$List$map, $author$project$GraphQL$Operations$Generate$buildRecordFromVariantFields, fields))
											])))));
					}
				}()));
	} else {
...
var $author$project$Elm$unit = $author$project$Internal$Compiler$Expression(
	{
		annotation: $elm$core$Result$Ok($stil4m$elm_syntax$Elm$Syntax$TypeAnnotation$Unit),
		expression: $stil4m$elm_syntax$Elm$Syntax$Expression$UnitExpr,
		imports: _List_Nil,
		skip: false
	});
var $author$project$GraphQL$Operations$Generate$generateDecoder = F2(
	function (schema, defs) {
		if (!defs.b) {
			return $author$project$Elm$Gen$Json$Decode$succeed($author$project$Elm$unit);
		} else {
			if ((defs.a.$ === 'Operation') && (!defs.b.b)) {
				var op = defs.a.a;
				var opName = A2(
					$elm$core$Maybe$withDefault,
					'Query',
					A2($elm$core$Maybe$map, $author$project$GraphQL$Operations$CanonicalAST$nameToString, op.name));
				return A2(
					$author$project$GraphQL$Operations$Generate$decodeFields,
					op.fields,
					$author$project$Elm$Gen$Json$Decode$succeed(
						$author$project$Elm$value(opName)));
			} else {
				return $author$project$Elm$Gen$Json$Decode$succeed($author$project$Elm$unit);
			}
		}
...
var $author$project$GraphQL$Operations$Generate$enumType = function (enumName) {
	return A2(
...
var $author$project$GraphQL$Operations$Generate$getScalarType = F3(
	function (queryName, field, schema) {
		var _v0 = A2($elm$core$Dict$get, queryName, schema.queries);
		if (_v0.$ === 'Nothing') {
			var _v1 = A2($elm$core$Dict$get, queryName, schema.objects);
			if (_v1.$ === 'Nothing') {
				var _v2 = A2(
					$elm$core$Debug$log,
					'Not an object',
					_Utils_Tuple2(queryName, field));
				return $author$project$GraphQL$Schema$Type$Scalar(queryName + ('.' + (field + 'NOT AN OBJECT?!')));
			} else {
				var object = _v1.a;
				var found = A2(
					$elm$core$List$filter,
					function (f) {
						return _Utils_eq(f.name, field);
					},
					object.fields);
				var _v3 = $elm$core$List$head(found);
				if (_v3.$ === 'Nothing') {
					return $author$project$GraphQL$Schema$Type$Scalar('NOT FOUND?!');
				} else {
					var foundField = _v3.a;
					return foundField.type_;
				}
			}
		} else {
			var q = _v0.a;
			...
			if (_v4.$ === 'Object') {
				var objName = _v4.a;
				var _v5 = A2($elm$core$Dict$get, objName, schema.objects);
				if (_v5.$ === 'Nothing') {
					return $author$project$GraphQL$Schema$Type$Scalar('WHAAT?!?!');
				} else {
					var object = _v5.a;
					var found = A2(
						$elm$core$List$filter,
						...
						object.fields);
					var _v6 = $elm$core$List$head(found);
					if (_v6.$ === 'Nothing') {
						return $author$project$GraphQL$Schema$Type$Scalar('NOT FOUND?!');
					} else {
						var foundField = _v6.a;
						return foundField.type_;
					}
				}
			} else {
...
var $author$project$GraphQL$Operations$Generate$schemaTypeToPrefab = function (schemaType) {
	switch (schemaType.$) {
		case 'Scalar':
		...
		case 'List_':
			...
			return $author$project$Elm$Annotation$list(
				$author$project$GraphQL$Operations$Generate$schemaTypeToPrefab(inner));
		default:
			var inner = schemaType.a;
...
var $author$project$Generate$Input$wrapElmType = F2(
	function (wrapper, exp) {
		switch (wrapper.$) {
			case 'InList':
				var inner = wrapper.a;
				return $author$project$Elm$Annotation$list(
					A2($author$project$Generate$Input$wrapElmType, inner, exp));
			case 'InMaybe':
				var inner = wrapper.a;
				return $author$project$Elm$Annotation$maybe(
					A2($author$project$Generate$Input$wrapElmType, inner, exp));
...
var $author$project$GraphQL$Operations$Generate$fieldAnnotation = F3(
	function (schema, parent, selection) {
		switch (selection.$) {
			case 'Field':
				var field = selection.a;
				return _Utils_Tuple2(
					function () {
						var _v1 = field.alias_;
						if (_v1.$ === 'Nothing') {
							return $author$project$GraphQL$Operations$CanonicalAST$nameToString(field.name);
						} else {
							var alias = _v1.a;
							return $author$project$GraphQL$Operations$CanonicalAST$nameToString(alias);
						}
					}(),
					function () {
						var _v2 = field.selection;
						if (!_v2.b) {
							if (parent.$ === 'Nothing') {
								return $author$project$Elm$Annotation$unit;
							} else {
								var par = parent.a;
								return $author$project$GraphQL$Operations$Generate$schemaTypeToPrefab(
									A3(
										$author$project$GraphQL$Operations$Generate$getScalarType,
										par,
										$author$project$GraphQL$Operations$CanonicalAST$nameToString(field.name),
										schema));
							}
						} else {
							var sels = _v2;
							return $author$project$Elm$Annotation$record(
								A2(
									$elm$core$List$map,
									A2(
										$author$project$GraphQL$Operations$Generate$fieldAnnotation,
										schema,
										$elm$core$Maybe$Just(
											$author$project$GraphQL$Operations$CanonicalAST$nameToString(field.name))),
									field.selection));
				...
				return _Utils_Tuple2(
					...
					function () {
						...
						if (!_v5.b) {
							...
							var sels = _v5;
							return A2(
								$author$project$Generate$Input$wrapElmType,
								field.wrapper,
			...
			case 'FieldScalar':
				...
				return _Utils_Tuple2(
					...
					$author$project$GraphQL$Operations$Generate$schemaTypeToPrefab(field.type_));
			case 'FieldEnum':
				var field = selection.a;
				return _Utils_Tuple2(
					function () {
						var _v8 = field.alias_;
						if (_v8.$ === 'Nothing') {
							return $author$project$GraphQL$Operations$CanonicalAST$nameToString(field.name);
						} else {
							var alias = _v8.a;
					...
					$author$project$GraphQL$Operations$Generate$enumType(field.enumName));
			case 'UnionCase':
				var field = selection.a;
				return _Utils_Tuple2(
					$author$project$GraphQL$Operations$CanonicalAST$nameToString(field.tag),
					A2(
						$author$project$Elm$Annotation$named,
						_List_Nil,
						$author$project$GraphQL$Operations$CanonicalAST$nameToString(field.tag)));
			...
			default:
				var _v12 = A2($elm$core$Debug$log, 'NOT IMPLEMENTED', selection);
				return A2(
					_Debug_todo(
						'GraphQL.Operations.Generate',
						{
							start: {line: 473, column: 13},
							end: {line: 473, column: 23}
						}),
					'Field not implemented!',
					selection);
		}
	});
var $author$project$GraphQL$Operations$Generate$generatePrimaryResultType = F2(
	function (schema, def) {
		if (def.$ === 'Fragment') {
			var frag = def.a;
			return _List_Nil;
			...
			return _List_fromArray(
				[
					...
					$author$project$Elm$Annotation$record(
						A2(
							$elm$core$List$map,
							A2($author$project$GraphQL$Operations$Generate$fieldAnnotation, schema, $elm$core$Maybe$Nothing),
							op.fields)))
				]);
		}
	});
...
var $author$project$GraphQL$Operations$Generate$unionVariant = F2(
	function (schema, selection) {
		switch (selection.$) {
			case 'FieldScalar':
				var field = selection.a;
			...
			case 'UnionCase':
				var field = selection.a;
				var _v1 = A2($elm$core$List$filter, $author$project$GraphQL$Operations$Generate$removeTypename, field.selection);
				if (!_v1.b) {
					return $elm$core$Maybe$Just(
						$author$project$Elm$variant(
							$author$project$GraphQL$Operations$CanonicalAST$nameToString(field.tag)));
				} else {
					var fields = _v1;
					return $elm$core$Maybe$Just(
						A2(
							$author$project$Elm$variantWith,
							$author$project$GraphQL$Operations$CanonicalAST$nameToString(field.tag),
							_List_fromArray(
								[
									$author$project$Elm$Annotation$record(
			...
			default:
				var _v2 = A2($elm$core$Debug$log, 'NOT IMPLEMENTED', selection);
				return A2(
					_Debug_todo(
						'GraphQL.Operations.Generate',
						{
					...
					'Union variant not implemented!',
					selection);
		}
	});
var $author$project$GraphQL$Operations$Generate$generateChildTypes = F2(
	function (schema, sel) {
		switch (sel.$) {
			case 'FieldObject':
				var obj = sel.a;
				return A2(
					$elm$core$List$concatMap,
					$author$project$GraphQL$Operations$Generate$generateChildTypes(schema),
					obj.selection);
			case 'FieldUnion':
				var field = sel.a;
				return A2(
					...
					A2(
						...
						A2(
							$elm$core$Maybe$withDefault,
							$author$project$GraphQL$Operations$CanonicalAST$nameToString(field.name),
							A2($elm$core$Maybe$map, $author$project$GraphQL$Operations$CanonicalAST$nameToString, field.alias_)),
						A2(
							$elm$core$List$filterMap,
							$author$project$GraphQL$Operations$Generate$unionVariant(schema),
							field.selection)),
					A2(
						$elm$core$List$concatMap,
						$author$project$GraphQL$Operations$Generate$generateChildTypes(schema),
...
var $author$project$GraphQL$Operations$Generate$generateResultTypes = F2(
	function (schema, def) {
		if (def.$ === 'Fragment') {
			var frag = def.a;
			return _List_Nil;
...
var $author$project$Generate$Args$annotation = F3(
	function (namespace, schema, input) {
		return A5(
			...
			schema,
			input,
			$author$project$Generate$Input$UnwrappedValue,
			{ergonomicOptionType: true});
	});
var $elm$core$Set$fromList = function (list) {
	return A3($elm$core$List$foldl, $elm$core$Set$insert, $elm$core$Set$empty, list);
};
var $author$project$GraphQL$Operations$Generate$primitives = $elm$core$Set$fromList(
	_List_fromArray(
		['Int', 'String', 'Float', 'Boolean', 'ID']));
var $author$project$GraphQL$Operations$Generate$isPrimitive = F2(
	function (schema, name) {
		return A2($elm$core$Dict$member, name, schema.scalars) ? true : A2($elm$core$Set$member, name, $author$project$GraphQL$Operations$Generate$primitives);
	});
var $author$project$GraphQL$Operations$Generate$toElmTypeHelper = F3(
	function (namespace, schema, astType) {
		switch (astType.$) {
			case 'Type_':
				var name = astType.a;
				var typename = $author$project$GraphQL$Operations$AST$nameToString(name);
				if (A2($author$project$GraphQL$Operations$Generate$isPrimitive, schema, typename)) {
					return A2($author$project$Elm$Annotation$named, _List_Nil, typename);
				} else {
					var _v1 = A2($elm$core$Dict$get, typename, schema.inputObjects);
					if (_v1.$ === 'Nothing') {
						return A2($author$project$Elm$Annotation$named, _List_Nil, typename);
					} else {
						var input = _v1.a;
						return A3($author$project$Generate$Args$annotation, namespace, schema, input);
					}
				}
			case 'List_':
				var inner = astType.a;
				return $author$project$Elm$Annotation$list(
					A3($author$project$GraphQL$Operations$Generate$toElmTypeHelper, namespace, schema, inner));
			default:
				var inner = astType.a;
				return $author$project$Elm$Annotation$maybe(
					A3($author$project$GraphQL$Operations$Generate$toElmTypeHelper, namespace, schema, inner));
...
var $author$project$GraphQL$Operations$Generate$toElmType = F3(
	function (namespace, schema, astType) {
		switch (astType.$) {
			case 'Type_':
				var name = astType.a;
				return A3($author$project$GraphQL$Operations$Generate$toElmTypeHelper, namespace, schema, astType);
			case 'List_':
				var inner = astType.a;
				return $author$project$Elm$Annotation$list(
					A3($author$project$GraphQL$Operations$Generate$toElmTypeHelper, namespace, schema, inner));
...
var $author$project$GraphQL$Operations$Generate$toVariableAnnotation = F3(
	function (namespace, schema, _var) {
		return _Utils_Tuple2(
			$author$project$GraphQL$Operations$CanonicalAST$nameToString(_var.variable.name),
			A3($author$project$GraphQL$Operations$Generate$toElmType, namespace, schema, _var.type_));
	});
var $author$project$GraphQL$Operations$Generate$getVariables = F3(
	function (namespace, schema, def) {
		if (def.$ === 'Fragment') {
			var frag = def.a;
			return _List_Nil;
			...
			return A2(
				$elm$core$List$map,
				A2($author$project$GraphQL$Operations$Generate$toVariableAnnotation, namespace, schema),
				op.variableDefinitions);
		}
	});
var $author$project$Elm$Gen$GraphQL$Engine$prebakedQuery = F3(
	function (arg1, arg2, arg3) {
		return A2(
			$author$project$Elm$apply,
			A3(
...
var $author$project$GraphQL$Operations$Generate$generate = F5(
	function (namespace, schema, queryStr, document, path) {
		var typeName = function () {
			var _v0 = document.definitions;
			if (!_v0.b) {
				return 'Query';
			} else {
				if ((_v0.a.$ === 'Operation') && (!_v0.b.b)) {
					var op = _v0.a.a;
					return A2(
						$elm$core$Maybe$withDefault,
						'Query',
		...
		var query = $author$project$Elm$expose(
			A3(
				...
				_Utils_Tuple2(
					...
					$author$project$Elm$Annotation$record(
						A2(
							$elm$core$List$concatMap,
							A2($author$project$GraphQL$Operations$Generate$getVariables, namespace, schema),
				...
				function (_var) {
					return A2(
						...
						A2(
							...
							A2($author$project$Elm$Annotation$named, _List_Nil, typeName)),
						A3(
							$author$project$Elm$Gen$GraphQL$Engine$prebakedQuery,
							$author$project$Elm$string(queryStr),
							$author$project$Elm$list(
								A2(
									$elm$core$List$concatMap,
									A2($author$project$GraphQL$Operations$Generate$encodeVariable, namespace, schema),
									document.definitions)),
							A2($author$project$GraphQL$Operations$Generate$generateDecoder, schema, document.definitions)));
				}));
		var primaryResult = A2(
			$elm$core$List$concatMap,
			$author$project$GraphQL$Operations$Generate$generatePrimaryResultType(schema),
			document.definitions);
		var helpers = A2(
			$elm$core$List$concatMap,
			$author$project$GraphQL$Operations$Generate$generateResultTypes(schema),
			document.definitions);
		return $elm$core$Result$Ok(
			_List_fromArray(
				[
						...
						_Utils_ap(
							...
							_Utils_ap(
								_List_fromArray(
									[query]),
								_List_fromArray(
									[$author$project$GraphQL$Operations$Generate$decodeHelper])))))
				]));
	});
...
var $author$project$GraphQL$Operations$AST$FragmentDetails = F4(
	function (name, typeCondition, directives, selectionSet) {
		return {directives: directives, name: name, selectionSet: selectionSet, typeCondition: typeCondition};
	});
var $author$project$GraphQL$Operations$AST$Directive = F2(
	function (name, _arguments) {
		return {_arguments: _arguments, name: name};
	});
var $elm$parser$Parser$Optional = {$: 'Optional'};
var $author$project$GraphQL$Operations$AST$Argument = F2(
	function (name, value) {
...
var $author$project$GraphQL$Operations$AST$Name = function (a) {
	return {$: 'Name', a: a};
};
var $author$project$GraphQL$Operations$Parse$keywords = $elm$core$Set$fromList(
	_List_fromArray(
		['query', 'subscription', 'mutation', 'on', 'fragment', 'true', 'false', 'null']));
var $author$project$GraphQL$Operations$Parse$multiOr = F2(
	function (conds, val) {
		return A3(
			$elm$core$List$foldl,
			F2(
...
var $author$project$GraphQL$Operations$Parse$name = A2(
	$elm$parser$Parser$map,
	$author$project$GraphQL$Operations$AST$Name,
	$elm$parser$Parser$variable(
		{
			inner: $author$project$GraphQL$Operations$Parse$multiOr(
				_List_fromArray(
					[
			...
			reserved: $author$project$GraphQL$Operations$Parse$keywords,
			start: $author$project$GraphQL$Operations$Parse$multiOr(
				_List_fromArray(
					[
						$elm$core$Char$isLower,
						$elm$core$Char$isUpper,
...
var $author$project$GraphQL$Operations$Parse$chars = {
	cr: $elm$core$Char$fromCode(13)
};
var $author$project$GraphQL$Operations$Parse$ignoreChars = $elm$core$Set$fromList(
	_List_fromArray(
		[
			_Utils_chr('\t'),
			_Utils_chr('\n'),
			$author$project$GraphQL$Operations$Parse$chars.cr,
			_Utils_chr(' '),
			_Utils_chr(',')
		]));
var $author$project$GraphQL$Operations$Parse$ws = $elm$parser$Parser$chompWhile(
	function (c) {
		return A2($elm$core$Set$member, c, $author$project$GraphQL$Operations$Parse$ignoreChars);
	});
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				A2(
					$elm$parser$Parser$ignorer,
					A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$name, $author$project$GraphQL$Operations$Parse$ws),
...
var $author$project$GraphQL$Operations$Parse$boolValue = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$map,
...
var $author$project$GraphQL$Operations$Parse$enumValue = A2($elm$parser$Parser$map, $author$project$GraphQL$Operations$AST$Enum, $author$project$GraphQL$Operations$Parse$name);
...
var $author$project$GraphQL$Operations$Parse$floatValue = A2($elm$parser$Parser$map, $author$project$GraphQL$Operations$AST$Decimal, $elm$parser$Parser$float);
...
var $author$project$GraphQL$Operations$Parse$intValue = A2($elm$parser$Parser$map, $author$project$GraphQL$Operations$AST$Integer, $elm$parser$Parser$int);
...
var $author$project$GraphQL$Operations$Parse$listValue = function (valueParser) {
	return A2(
		$elm$parser$Parser$map,
		$author$project$GraphQL$Operations$AST$ListValue,
		$elm$parser$Parser$sequence(
			{
				end: ']',
				item: $elm$parser$Parser$lazy(valueParser),
				separator: '',
				spaces: $author$project$GraphQL$Operations$Parse$ws,
				start: '[',
...
var $author$project$GraphQL$Operations$Parse$objectValue = function (valueParser) {
	return A2(
		$elm$parser$Parser$map,
		$author$project$GraphQL$Operations$AST$Object,
		$elm$parser$Parser$sequence(
			{
				end: '}',
				item: $author$project$GraphQL$Operations$Parse$kvp_(valueParser),
				separator: '',
				spaces: $author$project$GraphQL$Operations$Parse$ws,
				start: '{',
				trailing: $elm$parser$Parser$Optional
...
var $author$project$GraphQL$Operations$Parse$stringValue = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed($author$project$GraphQL$Operations$AST$Str),
		$elm$parser$Parser$symbol('\"')),
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$getChompedString(
			$elm$parser$Parser$chompIf(
				function (c) {
					return (!_Utils_eq(c, $author$project$GraphQL$Operations$Parse$chars.cr)) && ((!_Utils_eq(
						c,
						_Utils_chr('\n'))) && (!_Utils_eq(
						c,
						_Utils_chr('\"'))));
...
var $author$project$GraphQL$Operations$Parse$variable = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed($author$project$GraphQL$Operations$AST$Variable),
		$elm$parser$Parser$symbol('$')),
	$author$project$GraphQL$Operations$Parse$name);
function $author$project$GraphQL$Operations$Parse$cyclic$value() {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$author$project$GraphQL$Operations$Parse$boolValue,
				$author$project$GraphQL$Operations$Parse$intValue,
				$author$project$GraphQL$Operations$Parse$floatValue,
				$author$project$GraphQL$Operations$Parse$stringValue,
				$author$project$GraphQL$Operations$Parse$enumValue,
				A2($elm$parser$Parser$map, $author$project$GraphQL$Operations$AST$Var, $author$project$GraphQL$Operations$Parse$variable),
				$author$project$GraphQL$Operations$Parse$listValue(
				function (_v0) {
					return $author$project$GraphQL$Operations$Parse$cyclic$value();
				}),
				$author$project$GraphQL$Operations$Parse$objectValue(
				function (_v1) {
					return $author$project$GraphQL$Operations$Parse$cyclic$value();
				})
			]));
...
try {
	...
	throw 'Some top-level definitions from `GraphQL.Operations.Parse` are causing infinite recursion:\n\n  ┌─────┐\n  │    value\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $author$project$GraphQL$Operations$Parse$kvp = $author$project$GraphQL$Operations$Parse$kvp_(
	function (_v0) {
		return $author$project$GraphQL$Operations$Parse$value;
	});
var $author$project$GraphQL$Operations$Parse$argument = A2(
	$elm$parser$Parser$map,
	function (_v0) {
		var key = _v0.a;
		var v = _v0.b;
		return A2($author$project$GraphQL$Operations$AST$Argument, key, v);
	},
	$author$project$GraphQL$Operations$Parse$kvp);
var $author$project$GraphQL$Operations$Parse$arguments = $elm$parser$Parser$sequence(
	{end: ')', item: $author$project$GraphQL$Operations$Parse$argument, separator: '', spaces: $author$project$GraphQL$Operations$Parse$ws, start: '(', trailing: $elm$parser$Parser$Optional});
var $author$project$GraphQL$Operations$Parse$argumentsOpt = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			$author$project$GraphQL$Operations$Parse$arguments,
			$elm$parser$Parser$succeed(_List_Nil)
		]));
var $author$project$GraphQL$Operations$Parse$directive = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		A2(
			...
			A2(
				$elm$parser$Parser$ignorer,
				$elm$parser$Parser$succeed($author$project$GraphQL$Operations$AST$Directive),
				$elm$parser$Parser$symbol('@')),
			$author$project$GraphQL$Operations$Parse$ws),
		A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$name, $author$project$GraphQL$Operations$Parse$ws)),
	$author$project$GraphQL$Operations$Parse$argumentsOpt);
...
var $author$project$GraphQL$Operations$Parse$ifProgress = F2(
	function (onSucceed, parser) {
		return A2(
			$elm$parser$Parser$keeper,
			A2(
				$elm$parser$Parser$keeper,
				A2(
					...
					$elm$parser$Parser$succeed(
						F3(
							function (oldOffset, parsed, newOffset) {
								return _Utils_eq(oldOffset, newOffset) ? $elm$parser$Parser$Done(
									onSucceed(parsed)) : $elm$parser$Parser$Loop(parsed);
							})),
...
var $author$project$GraphQL$Operations$Parse$directivesHelper = function (dirs) {
	return A2(
		$author$project$GraphQL$Operations$Parse$ifProgress,
		$elm$core$List$reverse,
		$elm$parser$Parser$oneOf(
			_List_fromArray(
				[
					...
					$elm$parser$Parser$map,
					function (d) {
						return A2($elm$core$List$cons, d, dirs);
					},
...
var $author$project$GraphQL$Operations$Parse$directives = A2($elm$parser$Parser$loop, _List_Nil, $author$project$GraphQL$Operations$Parse$directivesHelper);
var $author$project$GraphQL$Operations$AST$Field = function (a) {
	return {$: 'Field', a: a};
};
var $author$project$GraphQL$Operations$AST$FragmentSpread = F2(
	function (name, directives) {
		return {directives: directives, name: name};
	});
var $author$project$GraphQL$Operations$AST$FragmentSpreadSelection = function (a) {
	return {$: 'FragmentSpreadSelection', a: a};
};
var $author$project$GraphQL$Operations$AST$InlineFragment = F3(
	function (tag, directives, selection) {
		return {directives: directives, selection: selection, tag: tag};
	});
var $author$project$GraphQL$Operations$AST$InlineFragmentSelection = function (a) {
	return {$: 'InlineFragmentSelection', a: a};
};
var $author$project$GraphQL$Operations$Parse$aliasedName = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed(
			F2(
				function (nameOrAlias, maybeActualName) {
					if (maybeActualName.$ === 'Nothing') {
						return _Utils_Tuple2($elm$core$Maybe$Nothing, nameOrAlias);
					} else {
						var actualName = maybeActualName.a;
						return _Utils_Tuple2(
							$elm$core$Maybe$Just(nameOrAlias),
							actualName);
					}
				})),
		$author$project$GraphQL$Operations$Parse$name),
...
var $author$project$GraphQL$Operations$Parse$loopItems = F2(
	function (contentParser, items) {
		return A2(
			$author$project$GraphQL$Operations$Parse$ifProgress,
			$elm$core$List$reverse,
			$elm$parser$Parser$oneOf(
				_List_fromArray(
					[
						...
						$elm$parser$Parser$map,
						function (d) {
							return A2($elm$core$List$cons, d, items);
						},
						contentParser),
						A2(
						$elm$parser$Parser$map,
		...
		A2(
			...
			A2(
				...
				A2(
					...
					$elm$parser$Parser$succeed(
						F4(
							function (_v1, args, dirs, sels) {
								var alias_ = _v1.a;
								var foundName = _v1.b;
								return {alias_: alias_, _arguments: args, directives: dirs, name: foundName, selection: sels};
							})),
					A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$aliasedName, $author$project$GraphQL$Operations$Parse$ws)),
				A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$argumentsOpt, $author$project$GraphQL$Operations$Parse$ws)),
			A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$directives, $author$project$GraphQL$Operations$Parse$ws)),
		$elm$parser$Parser$oneOf(
			_List_fromArray(
				[
		...
		$elm$parser$Parser$oneOf(
			_List_fromArray(
				[
					A2(
					$elm$parser$Parser$map,
					$author$project$GraphQL$Operations$AST$InlineFragmentSelection,
					A2(
						$elm$parser$Parser$keeper,
						A2(
							$elm$parser$Parser$keeper,
							A2(
								...
								A2(
									...
									A2(
										$elm$parser$Parser$ignorer,
										$elm$parser$Parser$succeed($author$project$GraphQL$Operations$AST$InlineFragment),
					...
					A2(
					$elm$parser$Parser$map,
					$author$project$GraphQL$Operations$AST$FragmentSpreadSelection,
					A2(
						$elm$parser$Parser$keeper,
						A2(
							$elm$parser$Parser$keeper,
							$elm$parser$Parser$succeed($author$project$GraphQL$Operations$AST$FragmentSpread),
							A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$name, $author$project$GraphQL$Operations$Parse$ws)),
						$author$project$GraphQL$Operations$Parse$directives))
				])));
}
		...
		A2(
			...
			A2(
				...
				A2(
					...
					_List_Nil,
					$author$project$GraphQL$Operations$Parse$loopItems(
								...
								return $elm$parser$Parser$oneOf(
									_List_fromArray(
										[
											A2(
											$elm$parser$Parser$map,
											$author$project$GraphQL$Operations$AST$Field,
											$author$project$GraphQL$Operations$Parse$cyclic$field_()),
...
try {
	...
	throw 'Some top-level definitions from `GraphQL.Operations.Parse` are causing infinite recursion:\n\n  ┌─────┐\n  │    field_\n  │     ↓\n  │    inlineOrSpread_\n  │     ↓\n  │    selectionSet\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $author$project$GraphQL$Operations$Parse$fragment = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$parser$Parser$ignorer,
						$elm$parser$Parser$succeed($author$project$GraphQL$Operations$AST$FragmentDetails),
						$elm$parser$Parser$keyword('fragment')),
					$author$project$GraphQL$Operations$Parse$ws),
				A2(
					$elm$parser$Parser$ignorer,
					A2(
			...
			A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$name, $author$project$GraphQL$Operations$Parse$ws)),
		A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$directives, $author$project$GraphQL$Operations$Parse$ws)),
	$author$project$GraphQL$Operations$Parse$selectionSet);
var $author$project$GraphQL$Operations$AST$OperationDetails = F5(
	function (operationType, name, variableDefinitions, directives, fields) {
		return {directives: directives, fields: fields, name: name, operationType: operationType, variableDefinitions: variableDefinitions};
	});
var $author$project$GraphQL$Operations$Parse$nameOpt = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$parser$Parser$map, $elm$core$Maybe$Just, $author$project$GraphQL$Operations$Parse$name),
			$elm$parser$Parser$succeed($elm$core$Maybe$Nothing)
		]));
var $author$project$GraphQL$Operations$AST$Mutation = {$: 'Mutation'};
var $author$project$GraphQL$Operations$AST$Query = {$: 'Query'};
var $author$project$GraphQL$Operations$Parse$operationType = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$map,
			function (_v0) {
				return $author$project$GraphQL$Operations$AST$Query;
			},
			$elm$parser$Parser$keyword('query')),
			A2(
			$elm$parser$Parser$map,
			function (_v1) {
				return $author$project$GraphQL$Operations$AST$Mutation;
			},
			$elm$parser$Parser$keyword('mutation'))
		]));
var $author$project$GraphQL$Operations$AST$VariableDefinition = F3(
	function (variable, type_, defaultValue) {
		return {defaultValue: defaultValue, type_: type_, variable: variable};
	});
var $author$project$GraphQL$Operations$Parse$defaultValue = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$map,
			...
			A2(
				...
				A2(
					...
					A2(
						...
						$elm$parser$Parser$symbol('=')),
					$author$project$GraphQL$Operations$Parse$ws),
				$author$project$GraphQL$Operations$Parse$value)),
			$elm$parser$Parser$succeed($elm$core$Maybe$Nothing)
		]));
...
function $author$project$GraphQL$Operations$Parse$cyclic$type_() {
	return A2(
		...
		A2(
			...
			$elm$parser$Parser$succeed(
				F2(
					function (base, isRequired) {
						return isRequired ? base : $author$project$GraphQL$Operations$AST$Nullable(base);
					})),
			$elm$parser$Parser$oneOf(
				_List_fromArray(
					[
						A2($elm$parser$Parser$map, $author$project$GraphQL$Operations$AST$Type_, $author$project$GraphQL$Operations$Parse$name),
						A2(
						$elm$parser$Parser$map,
						$author$project$GraphQL$Operations$AST$List_,
						$author$project$GraphQL$Operations$Parse$listType(
							function (_v0) {
...
try {
	...
	throw 'Some top-level definitions from `GraphQL.Operations.Parse` are causing infinite recursion:\n\n  ┌─────┐\n  │    type_\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $author$project$GraphQL$Operations$Parse$variableDefinition = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
			$elm$parser$Parser$succeed($author$project$GraphQL$Operations$AST$VariableDefinition),
			A2(
				$elm$parser$Parser$ignorer,
				A2(
					$elm$parser$Parser$ignorer,
					A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$variable, $author$project$GraphQL$Operations$Parse$ws),
					$elm$parser$Parser$symbol(':')),
				$author$project$GraphQL$Operations$Parse$ws)),
		A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$type_, $author$project$GraphQL$Operations$Parse$ws)),
	$author$project$GraphQL$Operations$Parse$defaultValue);
var $author$project$GraphQL$Operations$Parse$variableDefinitions = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			$elm$parser$Parser$sequence(
			{end: ')', item: $author$project$GraphQL$Operations$Parse$variableDefinition, separator: '', spaces: $author$project$GraphQL$Operations$Parse$ws, start: '(', trailing: $elm$parser$Parser$Optional}),
			$elm$parser$Parser$succeed(_List_Nil)
		]));
var $author$project$GraphQL$Operations$Parse$operation = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		A2(
			...
			A2(
				...
				A2(
					$elm$parser$Parser$keeper,
					$elm$parser$Parser$succeed($author$project$GraphQL$Operations$AST$OperationDetails),
					A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$operationType, $author$project$GraphQL$Operations$Parse$ws)),
				A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$nameOpt, $author$project$GraphQL$Operations$Parse$ws)),
			A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$variableDefinitions, $author$project$GraphQL$Operations$Parse$ws)),
		A2($elm$parser$Parser$ignorer, $author$project$GraphQL$Operations$Parse$directives, $author$project$GraphQL$Operations$Parse$ws)),
	$author$project$GraphQL$Operations$Parse$selectionSet);
var $author$project$GraphQL$Operations$Parse$definition = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$parser$Parser$map, $author$project$GraphQL$Operations$AST$Fragment, $author$project$GraphQL$Operations$Parse$fragment),
			A2($elm$parser$Parser$map, $author$project$GraphQL$Operations$AST$Operation, $author$project$GraphQL$Operations$Parse$operation)
		]));
		...
		$elm$parser$Parser$oneOf(
			_List_fromArray(
				[
					...
					$elm$parser$Parser$map,
					function (d) {
						return A2($elm$core$List$cons, d, defs);
					},
...
var $author$project$GraphQL$Operations$Parse$document = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed($author$project$GraphQL$Operations$AST$Document),
		$author$project$GraphQL$Operations$Parse$ws),
	A2(
		$elm$parser$Parser$ignorer,
		A2(
			$elm$parser$Parser$ignorer,
			A2($elm$parser$Parser$loop, _List_Nil, $author$project$GraphQL$Operations$Parse$loopDefinitions),
			$author$project$GraphQL$Operations$Parse$ws),
...
var $author$project$GraphQL$Operations$Parse$parse = function (doc) {
	return A2($elm$parser$Parser$run, $author$project$GraphQL$Operations$Parse$document, doc);
};
var $elm$core$Debug$toString = _Debug_toString;
var $author$project$Operations$parseAndValidateQuery = F3(
	function (namespace, schema, queryStr) {
		var _v0 = $author$project$GraphQL$Operations$Parse$parse(queryStr);
		if (_v0.$ === 'Err') {
			var err = _v0.a;
			return $author$project$Elm$Gen$error(
				{
					description: $elm$core$Debug$toString(err),
					title: 'Malformed query'
				});
		} else {
			var query = _v0.a;
			var _v1 = A2($author$project$GraphQL$Operations$Canonicalize$canonicalize, schema, query);
			if (_v1.$ === 'Err') {
				var errors = _v1.a;
				return $author$project$Elm$Gen$error(
					{
						description: A2(
							$elm$core$String$join,
							'\n\n    ',
							A2($elm$core$List$map, $author$project$GraphQL$Operations$Canonicalize$errorToString, errors)),
						title: 'Errors'
					});
			} else {
				var canAST = _v1.a;
				var _v2 = A5(
					$author$project$GraphQL$Operations$Generate$generate,
					namespace,
					schema,
					queryStr,
					canAST,
					...
					return $author$project$Elm$Gen$error(
						{
							description: A2(
								$elm$core$String$join,
								'\n\n    ',
								A2($elm$core$List$map, $author$project$GraphQL$Operations$Validate$errorToString, validationError)),
							title: 'Invalid query'
						});
				} else {
					var files = _v2.a;
					return $author$project$Elm$Gen$files(files);
				}
			}
		}
	});
var $author$project$Operations$smallDashboardQuery = 'query Dashboard(\n  $filter: PersonAppRelationshipFilter!\n\n) {\n  personAppRelationships(filter: $filter) {\n    totalEdges\n  }\n}\n';
var $elm$core$Platform$worker = _Platform_worker;
var $author$project$Operations$main = $elm$core$Platform$worker(
	{
		init: function (flags) {
			var decoded = A2($elm$json$Json$Decode$decodeValue, $author$project$Operations$flagsDecoder, flags);
			if (decoded.$ === 'Err') {
				var err = decoded.a;
				return _Utils_Tuple2(
					{flags: flags, input: $author$project$Operations$InputError, namespace: 'Api'},
				...
				switch (input.$) {
					...
					case 'SchemaInline':
						...
						return _Utils_Tuple2(
							...
							A3($author$project$Operations$parseAndValidateQuery, 'Api', schema, $author$project$Operations$smallDashboardQuery));
					default:
						var details = input.a;
						return _Utils_Tuple2(
							{flags: flags, input: input, namespace: details.namespace},
							A2($author$project$GraphQL$Schema$get, details.schema, $author$project$Operations$SchemaReceived));
				}
			}
		},
		...
		update: F2(
			function (msg, model) {
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						model,
						A3($author$project$Operations$parseAndValidateQuery, model.namespace, schema, $author$project$Operations$smallDashboardQuery));
				} else {
					var err = msg.a.a;
					return _Utils_Tuple2(
						model,
						$author$project$Elm$Gen$error(
							{
								description: 'Something went wrong with retrieving the schema.\n\n    ' + $author$project$Operations$httpErrorToString(err),
								title: 'Error retieving schema'
							}));
				}
			})
	});
_Platform_export({'Operations':{'init':$author$project$Operations$main($elm$json$Json$Decode$value)(0)}});}(this));